...
export type UserListFragment_users = {
    readonly users: {
    ...
    readonly " $refType": "UserListFragment_users";
};
export type UserListFragment_users$data = UserListFragment_users;
export type UserListFragment_users$key = {
    readonly " $data"?: UserListFragment_users$data;
